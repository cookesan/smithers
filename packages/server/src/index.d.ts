...
type GatewayControlPlaneAuditStore = {
...
type GatewayControlPlaneAuditConfig = {
...
declare class Gateway {
   ...
   */
    ...
    stateVersion: number;
    startedAtMs: number;
    controlPlane: GatewayControlPlaneAuditConfig | null;
    /**
